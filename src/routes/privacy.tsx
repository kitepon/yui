  ...
  return (
    <LegalPage title="プライバシーポリシー">
      <section>
        ...
        <p>アカウントのメールと名前、家の設定、家電クラウドへ接続するためのトークンです。トークンはサーバー上で暗号化して保存し、画面や API の応答に平文を出しません。</p>
      </section>
      <section>
        <h2 className="font-medium text-fg">利用目的</h2>
        <p>家電の操作、オートメーションの実行、障害対応、法令上の義務の履行に使います。広告には使わず、第三者に販売しません。</p>
      </section>
      <section>
        <h2 className="font-medium text-fg">委託</h2>
        <p>公開面の一部に Cloudflare を使います。Google でログインする場合は Google が認証を扱います。それぞれ必要な範囲だけ渡します。</p>
      </section>
      <section>
